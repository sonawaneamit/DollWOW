...
import { buildDollVuePrompt, resolveDollVueSelections, dollVueConfigForProduct, dollVueGroups } from "@/lib/dollvue/config";
...
const config: BrandCustomizationConfig = {
  ...
  groups: [
    { id: "skin-tone", label: "Skin Tone", display: "swatches", options: [
      { id: "tan", label: "Tan", dollVueEnabled: true, swatch: { kind: "image", value: "https://example.com/tan.jpg" } },
    ...
    { id: "premium-head-options", label: "Premium", display: "swatches", options: [
      { id: "add-moles-freckles", label: "Add Moles & Freckles", dollVueEnabled: true, swatch: { kind: "image", value: "https://example.com/freckles.jpg" } }
    ] }
  ]
};
