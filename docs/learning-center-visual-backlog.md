...
- Prefer vertical mobile-first assets for educational guides: `1024x1536`.
- Use text inside the image when it improves usefulness, but inspect every word before publishing.
- Avoid decorative visuals that do not teach anything.
- Avoid off-category sex toys, dildos, explicit scenes, school themes, underage-coded styling, fake reviews, or claims that imply a specific product result.
...
| `/learn/how-silicone-sex-dolls-are-made` | From sculpt to shipment | Vertical | Sculpt and mold, skeleton positioning, material casting, demolding and trimming, hand finishing, assembly and inspection, and protective packing | Use a real adult-looking current Irontech or other carried-brand catalog doll as the product context, supported by clear process illustrations. Do not publish exact temperatures, formulas, cure periods, proprietary internals, or one factory's process as a universal standard. Generate one sample and approve before publishing the prepared guide. |
...
| `/learn/6ye-dolls-buying-guide` | Editorial range map | Vertical collage | TPE full-body, silicone-head, male build, body/head pairing, handling, options, and storage | First visual live in code using three different 6YE products. Additional Amor or compatibility visuals must use other 6YE products. |
| `/learn/se-doll-buying-guide` | Beauty editorial finish guide | Vertical contact sheet | TPE versus Silicone Pro, makeup level, exact body/head pairing, and finish-specific care | First visual live in code using SE Doll Avery, Kiko, and Annika only. Additional option or finish visuals must use different SE Doll products. |
| `/learn/tantaly-buying-guide` | Product-format range guide | Landscape catalog comparison | Smaller, mid-size, larger, female, and male formats plus the dimensions and material checks that matter | Featured visual live in code using only current Tantaly products. It shows verified dual-unit heights and keeps fuller specifications in live page content. |
| `/learn/erovenus-dolls-review-guide` | Review-evidence contact sheet | Landscape editorial comparison | Product form, surface finish, complete scale, and the evidence a useful review should provide | Featured visual live in code using only current Erovenus products. Product facts and ordering details remain live page content. |
| `/learn/piper-dolls-buying-guide` | Adult Piper range and review-evidence guide | Vertical editorial comparison | Separate compact and full-size builds, TPE and silicone, handling weight, exact model evidence, and supported options | Approved Piper-only visual uses the current adult Piper Lana silicone doll, dual-unit catalog context, and customer-facing material and size prompts. The live six-product comparison uses varied current Piper models across compact, TPE, and silicone paths. |
