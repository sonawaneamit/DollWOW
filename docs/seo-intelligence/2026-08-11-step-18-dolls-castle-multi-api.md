# Brand Multi-API Intelligence

Generated: 2026-08-11T20:21:45.001Z
...
- Mode: execute
- Brands: Dolls Castle sex doll
- Requests: 3
- Failed requests: 0
- Recorded cost: $0.0489

## Requests

| API | Endpoint | Decision supported | Cost | Status |
| --- | --- | --- | ---: | --- |
| Backlinks | `/backlinks/summary/live` | Establish the manufacturer domain backlink baseline for Dolls Castle sex doll. | $0.0240 | Ok. |
| Backlinks | `/backlinks/domain_pages/live` | Find the Dolls Castle sex doll pages that have attracted the most links and reveal useful linkable formats. | $0.0247 | Ok. |
| OnPage | `/on_page/instant_pages` | Capture the current crawlable on-page baseline for https://dollwow.com/brands/dolls-castle before the upgrade. | $0.0001 | Ok. |
