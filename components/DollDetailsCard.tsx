    ...
    <section className="rounded-[20px] border border-gold-500/16 bg-ink-800/72 p-6">
      <div className="mb-5 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-ivory-400">Product record, fulfillment notes, and key specs.</p>
        </div>
      </div>
...
function cleanNote(note?: string) {
  if (!note) return "We confirm final details before checkout or production.";
  return note
    .replace(/^Prepared from .*?\. Review supplier authorization, pricing, images, and option mapping before publish\.$/i, "Final details are confirmed before checkout or production.")
    .replace(/Draft import generated by DollWow\.[^.]*\./gi, "Final details are confirmed before checkout or production.");
}
