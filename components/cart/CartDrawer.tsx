      ...
      <aside className="absolute inset-y-0 right-0 flex w-full max-w-md flex-col border-l border-gold-500/20 bg-[linear-gradient(180deg,#160d0a,#0c0605)] shadow-soft">
        <div className="flex items-center justify-between border-b border-gold-500/16 px-5 py-4">
          ...
          <button
            ...
            className="rounded-[12px] border border-gold-500/20 p-2 text-ivory-300 transition hover:border-gold-300/50 hover:text-ivory-50"
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          ...
                          className="rounded-[10px] p-1.5 text-ivory-500 transition hover:bg-ivory-50/[0.06] hover:text-danger"
                      ...
                      <div className="mt-2 flex items-center justify-between">
                        <div className="inline-flex items-center rounded-full border border-gold-500/18">
                          <button
                            ...
                            className="px-2.5 py-1.5 text-ivory-300 hover:text-ivory-50"
