...
export default async function PriceMatchResultPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8"><ComparisonResult request={request} product={product} /></section>;
}
