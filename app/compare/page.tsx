...
export default async function ComparePage({
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      <div>
        <p className="text-sm text-accent">Live price comparison</p>
        <h1 className="mt-2 text-4xl font-semibold text-text">Request a price match</h1>
        <p className="mt-3 max-w-3xl text-text-dim">Share the competitor product link, the final quoted total, and a screenshot of the configured cart or summary. That gives us enough to review the real offer instead of only the base page.</p>
      </div>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)]">
        <div className="rounded-[24px] border border-border bg-surface p-6 shadow-card sm:p-8">
