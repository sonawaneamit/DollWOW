  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        {["Clean product pages", "Specialist buyer support", "Clear stock and delivery notes", "Supplier authorization workflow", "Price-list and asset tracking", "No fake social proof"].map((item) => (
